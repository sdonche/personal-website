...
(() => {
  ...
  const SECTIONS = [
    ...
    { id: "note-ignition-observability", label: "ignition-observability", group: "notes", page: true, href: "notes/ignition-observability/", desc: "Article" },
    { id: "note-ignition-historian", label: "ignition-historian", group: "notes", page: true, href: "notes/ignition-historian/", desc: "Article" },
    { id: "note-ignition-amqp", label: "ignition-amqp", group: "notes", page: true, href: "notes/ignition-amqp/", desc: "Article" },
    { id: "note-ignition-alarms", label: "ignition-alarms", group: "notes", page: true, href: "notes/ignition-alarms/", desc: "Article" },
    { id: "note-ignition-perspective", label: "ignition-perspective", group: "notes", page: true, href: "notes/ignition-perspective/", desc: "Article" },
    { id: "note-ignition-dark-mode", label: "ignition-dark-mode", group: "notes", page: true, href: "notes/ignition-dark-mode/", desc: "Article" },
    { id: "note-ignition-doom", label: "ignition-doom", group: "notes", page: true, href: "notes/ignition-doom/", desc: "Article" },
    { id: "note-ignition-modules", label: "ignition-modules", group: "notes", page: true, href: "notes/ignition-modules/", desc: "Article" },
    ...
    { id: "plant",                label: "plant-hmi", page: true, href: "plant/", desc: "Heuvelland chocolate plant HMI" },
